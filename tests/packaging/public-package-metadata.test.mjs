...
test("@tsrx/oxc is the complete public toolchain boundary", async () => {
  ...
  assert.deepEqual(Object.entries(manifest.optionalDependencies), [
    ["@tsrx/oxc-darwin-arm64", "0.15.0"],
    ["@tsrx/oxc-darwin-x64", "0.15.0"],
    ["@tsrx/oxc-linux-arm64-gnu", "0.15.0"],
    ["@tsrx/oxc-linux-arm64-musl", "0.15.0"],
    ["@tsrx/oxc-linux-x64-gnu", "0.15.0"],
    ["@tsrx/oxc-linux-x64-musl", "0.15.0"],
    ["@tsrx/oxc-win32-arm64-msvc", "0.15.0"],
    ["@tsrx/oxc-win32-x64-msvc", "0.15.0"],
  ]);
