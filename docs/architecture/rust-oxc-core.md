...
renderer holds 16.13 MiB/s on the stress corpus and 99.18 MiB/s on the fast
...
- Linting and formatting ordinary JS/TS/TSX files adds no measurable
  ...
  of MiB/s.
- On a matched 1,000-file corpus the CLI finishes in about 56 ms, where
  official Oxlint takes about 46 ms and ESLint takes about 733 ms.
- Type-aware lint costs roughly 25 ms per file, and editor responses stay
  well under a millisecond after a fresh open of about 3.0 ms.
