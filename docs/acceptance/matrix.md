...
| --- | --- | --- | --- |
| Native lint | 216.30 MiB/s median scan/project/parse; 67.84 MiB/s complete CLI lint; 1.221× equivalent-TSX CLI latency; 3.88 ms fresh-process p95 | 19/19 pass across one adjudication reports | [`native-lint/results-1789846859997.json`](../../benchmarks/native-lint/results-1789846859997.json) |
| Native format | 99.18 MiB/s sequential; 322.35 MiB/s default-thread p95; 16.13 MiB/s generalized control; 3.36 ms fresh-stdin p95; 1.118× complete-output RSS | 25/25 pass across one adjudication reports | [`native-format/results-1789846871499.json`](../../benchmarks/native-format/results-1789846871499.json) |
| Type-aware lint | Default syntax 3.45 ms p95 with zero type processes; one-file type-aware 27.18 ms p95; two-file project 27.93 ms p95; one type process per batch | 8/8 pass | [`type-aware/results-1789846873134.json`](../../benchmarks/type-aware/results-1789846873134.json) |
| Vite/Vite+ process boundary | Ordinary Oxfmt 36.93 ms p95 / 1.123× canonical; mixed lint 65.69 ms p95 / 1.926×; mixed format 66.57 ms p95 / 2.024×; Vite+ 0.2.4 mixed lint 296.54 ms p95; one native TSRX parse | 8/8 pass | [`vite/results-1789846886123.json`](../../benchmarks/vite/results-1789846886123.json) |
| Incremental editor | Fresh open 3.00 ms median / 3.86 ms p95 across 100 samples; diagnostics 0.169 ms p95; format 0.138 ms p95; code action 0.155 ms p95; 10.63 MiB RSS and 0 MiB growth after 1,000 edits | 8/8 pass | [`editor/results-1789846886872.json`](../../benchmarks/editor/results-1789846886872.json) |
| Matched CLI comparison | Same 1,000 explicit TSX files, one rule, every lane through its npm CLI: ESLint 732.88 ms, official Oxlint 46.11 ms, OXC for TSRX npm CLI 55.62 ms median through the zero-dispatch declared-bin route; paired 20% TSRX workload 78.38 ms / 1.409× all-TSX | All 3 assertions pass in a single unadjudicated fresh report | [`comparative/results-1789846911273.json`](../../benchmarks/comparative/results-1789846911273.json) |
