...
| --- | --- | --- | --- |
| Native lint | 216.73 MiB/s median scan/project/parse; 73.91 MiB/s complete CLI lint; 1.237× equivalent-TSX CLI latency; 3.28 ms fresh-process p95 | 19/19 pass across one adjudication reports | [`native-lint/results-1789793998670.json`](../../benchmarks/native-lint/results-1789793998670.json) |
| Native format | 117.41 MiB/s sequential; 801.20 MiB/s default-thread p95; 18.36 MiB/s generalized control; 2.73 ms fresh-stdin p95; 1.236× complete-output RSS | 25/25 pass across one adjudication reports | [`native-format/results-1789794009881.json`](../../benchmarks/native-format/results-1789794009881.json) |
| Type-aware lint | Default syntax 2.74 ms p95 with zero type processes; one-file type-aware 24.68 ms p95; two-file project 26.08 ms p95; one type process per batch | 8/8 pass | [`type-aware/results-1789794011376.json`](../../benchmarks/type-aware/results-1789794011376.json) |
| Vite/Vite+ process boundary | Ordinary Oxfmt 33.98 ms p95 / 1.121× canonical; mixed lint 60.92 ms p95 / 1.826×; mixed format 59.26 ms p95 / 1.955×; Vite+ 0.2.4 mixed lint 260.65 ms p95; one native TSRX parse | 8/8 pass | [`vite/results-1789794023265.json`](../../benchmarks/vite/results-1789794023265.json) |
| Incremental editor | Fresh open 2.56 ms median / 2.80 ms p95 across 100 samples; diagnostics 0.116 ms p95; format 0.105 ms p95; code action 0.105 ms p95; 10.52 MiB RSS and 0 MiB growth after 1,000 edits | 8/8 pass | [`editor/results-1789794023919.json`](../../benchmarks/editor/results-1789794023919.json) |
| Matched CLI comparison | Same 1,000 explicit TSX files, one rule, every lane through its npm CLI: ESLint 650.04 ms, official Oxlint 44.15 ms, OXC for TSRX npm CLI 50.98 ms median through the zero-dispatch declared-bin route; paired 20% TSRX workload 72.13 ms / 1.415× all-TSX | All 3 assertions pass in a single unadjudicated fresh report | [`comparative/results-1789794045675.json`](../../benchmarks/comparative/results-1789794045675.json) |
