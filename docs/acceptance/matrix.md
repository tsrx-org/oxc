...
| --- | --- | --- | --- |
| Native lint | 220.44 MiB/s median scan/project/parse; 71.55 MiB/s complete CLI lint; 1.229× equivalent-TSX CLI latency; 3.96 ms fresh-process p95 | 19/19 pass across one adjudication reports | [`native-lint/results-1789790934847.json`](../../benchmarks/native-lint/results-1789790934847.json) |
| Native format | 114.31 MiB/s sequential; 770.19 MiB/s default-thread p95; 18.21 MiB/s generalized control; 3.21 ms fresh-stdin p95; 1.237× complete-output RSS | 25/25 pass across one adjudication reports | [`native-format/results-1789790938649.json`](../../benchmarks/native-format/results-1789790938649.json) |
| Type-aware lint | Default syntax 2.85 ms p95 with zero type processes; one-file type-aware 24.58 ms p95; two-file project 25.33 ms p95; one type process per batch | 8/8 pass | [`type-aware/results-1789790940149.json`](../../benchmarks/type-aware/results-1789790940149.json) |
| Vite/Vite+ process boundary | Ordinary Oxfmt 38.42 ms p95 / 0.953× canonical; mixed lint 63.91 ms p95 / 1.888×; mixed format 61.50 ms p95 / 1.525×; Vite+ 0.2.4 mixed lint 272.16 ms p95; one native TSRX parse | 8/8 pass | [`vite/results-1789790952481.json`](../../benchmarks/vite/results-1789790952481.json) |
| Incremental editor | Fresh open 2.57 ms median / 2.83 ms p95 across 100 samples; diagnostics 0.132 ms p95; format 0.129 ms p95; code action 0.110 ms p95; 10.53 MiB RSS and 0.015625 MiB growth after 1,000 edits | 8/8 pass | [`editor/results-1789790953137.json`](../../benchmarks/editor/results-1789790953137.json) |
| Matched CLI comparison | Same 1,000 explicit TSX files, one rule, every lane through its npm CLI: ESLint 674.70 ms, official Oxlint 44.25 ms, OXC for TSRX npm CLI 51.24 ms median through the zero-dispatch declared-bin route; paired 20% TSRX workload 72.55 ms / 1.416× all-TSX | All 3 assertions pass in a single unadjudicated fresh report | [`comparative/results-1789790975810.json`](../../benchmarks/comparative/results-1789790975810.json) |
