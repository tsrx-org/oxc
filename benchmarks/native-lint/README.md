...
Aggregate-selected representative report: `results-1789839639381.json`, with 217.82 MiB/s
scan/project/parse-and-dynamic-validation, 70.02 MiB/s complete CLI lint,
1.232× CLI latency versus equivalent TSX, and 3.45 ms fresh-process p95. Its
