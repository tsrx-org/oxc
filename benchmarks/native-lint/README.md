...
Aggregate-selected representative report: `results-1789846859997.json`, with 216.30 MiB/s
scan/project/parse-and-dynamic-validation, 67.84 MiB/s complete CLI lint,
1.221× CLI latency versus equivalent TSX, and 3.88 ms fresh-process p95. Its
